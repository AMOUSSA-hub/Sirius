...
public class Bouton extends JButton  {
    Font font = LabelTxt.font;

    Bouton(String titre) {
        //this.setSize(Contenu.WIDTH/10, Contenu.HEIGHT/10);
        this.setText(titre);
        this.setBackground(Page.bg);
        this.setVisible(true);
        this.setLayout(null);
        this.setForeground(Color.WHITE);
        this.setBorder(new RoundBtn(45));
        this.setFont(font);
    }
    ...
    Bouton(int height,String txt) {
        this.height = height;
        setFont(font);
        this.width = getFontMetrics(font).stringWidth(txt) + 50;
        this.setPreferredSize(new Dimension(this.width, this.height));
        this.setBackground(java.awt.Color.BLACK);
        setForeground(Color.WHITE);
        this.setLayout(null);
